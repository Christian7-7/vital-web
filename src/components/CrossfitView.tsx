import { ChevronLeft, Flame, TrendingUp, Activity } from 'lucide-react';
import { Product } from '../types';
import { ProductCard } from './ProductCard';

interface CrossfitViewProps {
  products: Product[];
  onBack: () => void;
  onPurchase: (product: Product) => void;
}

export function CrossfitView({ products, onBack, onPurchase }: CrossfitViewProps) {
  const filteredProducts = products.filter(p => p.sport_category === 'crossfit');
    ...
    <div className="min-h-screen bg-textured-black">
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url(/Crossfit.jpg)' }}
        >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="animate-fadeIn">
            ...
            <p className="text-xl md:text-2xl text-white max-w-3xl mx-auto leading-relaxed font-light drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
              Suplementos de alto rendimiento para enfrentar cualquier WOD con máxima potencia
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
              Fórmulas diseñadas para atletas que buscan rendimiento extremo en entrenamientos funcionales de alta intensidad
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              ...
              <h3 className="font-brand text-2xl text-white mb-3">WOD PERFORMANCE</h3>
              <p className="text-gray-400 leading-relaxed">
                Energía explosiva y sostenida para completar los WODs más demandantes con máxima intensidad
              </p>
            </div>
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              <TrendingUp className="w-12 h-12 text-[#D8F100] mx-auto mb-4" />
              <h3 className="font-brand text-2xl text-white mb-3">FUERZA Y POTENCIA</h3>
              <p className="text-gray-400 leading-relaxed">
                Desarrolla fuerza máxima para levantamientos olímpicos y movimientos gimnásticos complejos
              </p>
            </div>
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              <Activity className="w-12 h-12 text-[#D8F100] mx-auto mb-4" />
              <h3 className="font-brand text-2xl text-white mb-3">RECUPERACIÓN RÁPIDA</h3>
              <p className="text-gray-400 leading-relaxed">
                Acelera la recuperación entre entrenamientos para mantener el volumen y la intensidad día tras día
              </p>
            </div>
          </div>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-20">
              <p className="text-gray-400 text-xl">
                Próximamente agregaremos suplementos exclusivos para crossfit
              </p>
            </div>
          )}
        </div>
