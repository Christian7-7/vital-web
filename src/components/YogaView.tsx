import { ChevronLeft, Heart, Wind, Flower2 } from 'lucide-react';
...
export function YogaView({ products, onBack, onPurchase }: YogaViewProps) {
  const filteredProducts = products.filter(p => p.sport_category === 'yoga');
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="animate-fadeIn">
            ...
            <p className="text-xl md:text-2xl text-white max-w-3xl mx-auto leading-relaxed font-light drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
              Suplementos naturales para potenciar tu flexibilidad, concentración y conexión mente-cuerpo
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
              Fórmulas holísticas para yoguis que buscan mayor flexibilidad, calma mental y recuperación profunda
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              <Flower2 className="w-12 h-12 text-[#D8F100] mx-auto mb-4" />
              <h3 className="font-brand text-2xl text-white mb-3">FLEXIBILIDAD</h3>
              <p className="text-gray-400 leading-relaxed">
                Mejora tu rango de movimiento y profundiza tus asanas con colágeno y magnesio para articulaciones
              </p>
            </div>
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              <Wind className="w-12 h-12 text-[#D8F100] mx-auto mb-4" />
              <h3 className="font-brand text-2xl text-white mb-3">CALMA MENTAL</h3>
              <p className="text-gray-400 leading-relaxed">
                Alcanza estados meditativos profundos con adaptógenos naturales que reducen el estrés y la ansiedad
              </p>
            </div>
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              <Heart className="w-12 h-12 text-[#D8F100] mx-auto mb-4" />
              <h3 className="font-brand text-2xl text-white mb-3">BIENESTAR INTEGRAL</h3>
              <p className="text-gray-400 leading-relaxed">
                Nutre tu cuerpo desde dentro con superalimentos y antioxidantes para vitalidad completa
              </p>
            </div>
          </div>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-20">
              <p className="text-gray-400 text-xl">
                Próximamente agregaremos suplementos exclusivos para yoga
              </p>
            </div>
          )}
        </div>
