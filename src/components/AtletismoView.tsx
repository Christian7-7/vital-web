import { ChevronLeft, Flame, Zap, Heart } from 'lucide-react';
import { Product } from '../types';
import { ProductCard } from './ProductCard';

interface AtletismoViewProps {
  products: Product[];
  onBack: () => void;
  onPurchase: (product: Product) => void;
}

export function AtletismoView({ products, onBack, onPurchase }: AtletismoViewProps) {
  const filteredProducts = products.filter(p => p.sport_category === 'atletismo');
    ...
    <div className="min-h-screen bg-textured-black">
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url(/Atletismo.jpg)' }}
        >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="animate-fadeIn">
            ...
            <p className="text-xl md:text-2xl text-white max-w-3xl mx-auto leading-relaxed font-light drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
              Suplementos diseñados para mejorar tu explosividad, resistencia y recuperación en pista
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
              Fórmulas especializadas para atletas que buscan maximizar su rendimiento en carreras y competencias
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              ...
              <h3 className="font-brand text-2xl text-white mb-3">ENERGÍA EXPLOSIVA</h3>
              <p className="text-gray-400 leading-relaxed">
                Pre-entrenamientos diseñados para darte la energía y enfoque necesarios para tus entrenamientos más intensos
              </p>
            </div>
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              ...
              <p className="text-gray-400 leading-relaxed">
                Fórmulas para mejorar tu capacidad aeróbica y mantener el ritmo durante distancias largas
              </p>
            </div>
            <div className="bg-[#141414] border border-[#D8F100]/20 p-8 rounded-xl text-center hover:border-[#D8F100] transition-all duration-300">
              <Heart className="w-12 h-12 text-[#D8F100] mx-auto mb-4" />
              <h3 className="font-brand text-2xl text-white mb-3">RECUPERACIÓN</h3>
              <p className="text-gray-400 leading-relaxed">
                Suplementos post-entrenamiento para acelerar la recuperación muscular y reducir la fatiga
              </p>
            </div>
          </div>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-20">
              <p className="text-gray-400 text-xl">
                Próximamente agregaremos suplementos exclusivos para atletismo
              </p>
            </div>
          )}
        </div>
